...
from tsne_animation import tsne_animation 
...
for epoch in range(num_epochs):
    ...
    for x, y in mnist_train:
        ...
        if batch % 50 == 0:
            print("Epoch {:03d}, Batch {:03d}:    Loss: {:.3f}, Accuracy: {:.3%}".format(epoch,
                                                                                         batch,
        ...
        if batch % 100 == 0:
            ...
            scat = plt.scatter(a2out_proj[ytsne.numpy() == 0, 0], a2out_proj[ytsne.numpy() == 0, 1], c=colors[0],
                               label=target_ids[0])

            for i, c, label in zip(target_ids[1:], colors[1:], np.arange(1, 10)):
                plt.scatter(a2out_proj[ytsne.numpy() == i, 0], a2out_proj[ytsne.numpy() == i, 1], c=c, label=label)
